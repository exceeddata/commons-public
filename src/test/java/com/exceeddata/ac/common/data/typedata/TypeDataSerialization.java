...
public class TypeDataSerialization {
    ...
    public void testExternalizable() throws IOException, ClassNotFoundException, EngineException {
        ...
        assertEquals(deserializeExternalizable(serializeExternalizable(location, NumericData.valueOf(100d))), NumericData.valueOf(100d));
        ...
        assertEquals(deserializeExternalizable(serializeExternalizable(location, NumericData.NULL)), NumericData.NULL);
        ...
        md.put(StringData.valueOf("a"), DoubleData.valueOf(0d));
        md.put(StringData.valueOf("a"), DoubleData.valueOf(2d));
        md.put(StringData.valueOf("a"), DoubleData.valueOf(0d));
        
        final MapData map = new MapData(md);
        assertEquals(deserializeExternalizable(serializeExternalizable(location, list)), list);
        assertEquals(deserializeExternalizable(serializeExternalizable(location, DataConv.toSetData(list))), DataConv.toSetData(list));
        assertEquals(deserializeExternalizable(serializeExternalizable(location, DataConv.toDenseVectorData(list))), DataConv.toDenseVectorData(list));
        assertEquals(deserializeExternalizable(serializeExternalizable(location, DataConv.toSparseVectorData(list))), DataConv.toSparseVectorData(list));
