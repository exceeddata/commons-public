 ...
 */
public final class ParentheseCommentParser {
    ...
    protected ParentheseCommentParser() {}
     ...
     */
    public ParentheseCommentParser (
     ...
     */
    public final ParentheseCommentParser setParentheseOpenChar(final char parentheseOpenChar) { 
        this.parentheseOpenChar = parentheseOpenChar; 
        return this;
    }
     ...
     * @return ParentheseParser
     */
    public final ParentheseCommentParser setParentheseCloseChar(final char parentheseCloseChar) { 
        this.parentheseCloseChar = parentheseCloseChar; 
        return this;
    }
     ...
     * @return ParentheseParser
     */
    public final ParentheseCommentParser setSeparatorChar(char separatorChar) { 
        this.separatorChar = separatorChar; 
        return this;
    }
     ...
     * @return ParentheseParser
     */
    public final ParentheseCommentParser setQuoteChar(char quoteChar) { 
        this.quoteChar = quoteChar; 
        return this;
    }
     ...
     * @return ParentheseParser
     */
    public final ParentheseCommentParser setEscapeChar(char escapeChar) { 
        this.escapeChar = escapeChar; 
        return this;
    }
     ...
     * @return ParentheseParser
     */
    public final ParentheseCommentParser setKeepEscapeChar(boolean keepEscapeChar) { 
        this.keepEscapeChar = keepEscapeChar; 
        return this;
    }   
    ...
    public final String[] split (final String str) {
        if (XStringUtils.isNotBlank(str)) {
            ...
            boolean quoted = false, commented = false;
